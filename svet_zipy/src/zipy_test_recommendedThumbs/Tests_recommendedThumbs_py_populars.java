...
public class Tests_recommendedThumbs_py_populars extends Tests_recommendedThumbs_MAIN {
	
	private static String thumbnail;
	private static String number;

	public Tests_recommendedThumbs_py_populars(String thumbnail, String number) {
		super();
	...
	//Test - opening thumbnails in populars (Portugal)
	@Test		
	public  void Tests_py_popularsThumbs() throws Exception {
		System.out.println("Running test for Portugal site - populars - opening thumbnail #" + number);		
