...
public class Tests_recommendedThumbs_cy_dailyDeal extends Tests_recommendedThumbs_MAIN {
	
	private static String thumbnail;
	private static String number;

	public Tests_recommendedThumbs_cy_dailyDeal(String thumbnail, String number) {
		super();
	...
	//Test - opening thumbnails (Cypress)
	@Test		
	public  void Tests_cy_dailyDealThumbs() throws Exception {
		System.out.println("Running test for Cypress site - dailyDeal - opening thumbnail #" + number);		
