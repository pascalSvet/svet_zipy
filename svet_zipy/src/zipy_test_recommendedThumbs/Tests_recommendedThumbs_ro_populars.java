...
public class Tests_recommendedThumbs_ro_populars extends Tests_recommendedThumbs_MAIN {
	
	private static String thumbnail;
	private static String number;

	public Tests_recommendedThumbs_ro_populars(String thumbnail, String number) {
		super();
	...
	//Test - opening thumbnails in populars (Romania)
	@Test		
	public  void Tests_ro_popularsThumbs() throws Exception {
		System.out.println("Running test for Romania site - populars - opening thumbnail #" + number);		
