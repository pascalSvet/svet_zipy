...
public class Tests_recommendedThumbs_gr_dailyDeal extends Tests_recommendedThumbs_MAIN {
	
	private static String thumbnail;
	private static String number;

	public Tests_recommendedThumbs_gr_dailyDeal(String thumbnail, String number) {
		super();
	...
	//Test - opening thumbnails in dailyDeal (Greece)
	@Test		
