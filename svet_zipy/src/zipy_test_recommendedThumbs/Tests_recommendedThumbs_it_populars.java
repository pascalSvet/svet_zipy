...
public class Tests_recommendedThumbs_it_populars extends Tests_recommendedThumbs_MAIN {
	
	private static String thumbnail;
	private static String number;

	public Tests_recommendedThumbs_it_populars(String thumbnail, String number) {
		super();
	...
	//Test - opening thumbnails in populars (Italy)
	@Test		
	public  void Tests_it_popularsThumbs() throws Exception {
		System.out.println("Running test for Italy site - populars - opening thumbnail #" + number);		
