...
public class Tests_cart_price extends Tests_cart_main {
	...
	public  void Tests_cart_price_includesDelivery() throws Exception {
		...
		String Sum = Tests_functions.priceSum(driver,Elements.Product_price,Elements.Product_delivery).trim();
		...
		Assert.assertTrue(driver.findElement(By.xpath(Elements.Product_cart_finalSum)).getText().contains(Sum));
	...
	public  void Tests_cart_price_includesDiscount() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(Elements.Product_variationsColor))).click();		
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(Elements.Product_addToCart))).click();
		Thread.sleep(3000);
		String priceAfterDiscount = driver.findElement(By.xpath(Elements.Product_discount)).getText();	
		...
		Assert.assertTrue(driver.findElement(By.xpath(Elements.Product_cart_finalSum)).getText().contains(priceAfterDiscount));
	...
	public  void Tests_cart_price_sumOfProducts() throws Exception {
		...
		driver.get(Elements.Product_noVariations);
		Thread.sleep(500);
		String price1 = Tests_functions.priceSum(driver, Elements.Product_price, Elements.Product_delivery).trim();
		
		//add to the cart 
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(Elements.Product_addToCart))).click();

		//get to the second product page and save its price
		driver.get(Elements.Product_noVariations2);
		Thread.sleep(500);
		String price2 = Tests_functions.priceSum(driver, Elements.Product_price, Elements.Product_delivery).trim();
	...
	public  void Tests_cart_price_quantity() throws Exception {
		...
		Thread.sleep(3000);
		String price = Tests_functions.priceSum(driver, Elements.Product_price, Elements.Product_delivery).trim();
	...
	public  void Tests_cart_price_diffElements() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(Elements.Product_variationsColor))).click();		
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(Elements.Product_variationsColor_1))).click();;
		Thread.sleep(3000);
		String price1 = driver.findElement(By.xpath(Elements.Product_discount)).getText().trim();	
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(Elements.Product_variationsColor_3))).click();;
		Thread.sleep(3000);
		String price2 = driver.findElement(By.xpath(Elements.Product_discount)).getText().trim();	
	...
	public  void Tests_cart_price_removingProduct() throws Exception {
		...
		Assert.assertTrue(driver.findElement(By.xpath(Elements.Product_cart_finalSum)).getText().contains(price2));
	...
	public  void Tests_cart_price_changeQuantity() throws Exception {
		...
		Assert.assertTrue(driver.findElement(By.xpath(Elements.Product_cart_finalSum)).getText().contains(price));
